...
const CourseSingleThree = (props) => {
    const { courseClass, courseCategory, courseImg, courseTitle, coursePrice, userRating, studentQuantity } = props;
        ...
        <div className={courseClass ? courseClass :'course-wrap'}>
            <div className="front-part">
                ...
                <div className="content-part">
                    <Link className="categorie" to="#">{courseCategory ? courseCategory : 'Artificial Intelligence'}</Link>
            ...
            <div className="price-btn">
                <Link to="#">{coursePrice ? coursePrice : '$55.00'} <i className="flaticon-next"></i></Link>
            </div>
        </div>
