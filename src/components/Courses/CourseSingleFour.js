...
const CourseSingleFour = (props) => {
    const { courseClass, courseCategory, courseImg, courseTitle, coursePrice, studentQuantity, userRating, btnText, metaIcon } = props;
    ...
    return (
        <div className={courseClass ? courseClass : 'courses-item'}>
            ...
            <div className="content-part">
                <span>
                    <Link className="categories" to="#">{courseCategory ? courseCategory : 'Web Development'}</Link>
                </span>
