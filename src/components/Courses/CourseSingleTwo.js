...
const CourseSingleTwo = (props) => {
    const { courseClass, courseImg, courseTitle, coursePrice, courseCategory, userCount, userRating } = props;
    return (
        <div className={courseClass ? courseClass : 'courses-item'}>
            ...
            <div className="content-part">
                <ul className="meta-part">
                    ...
                    <li><Link className="categorie" to="#">{courseCategory ? courseCategory : 'Web Development'}</Link></li>
                </ul>
