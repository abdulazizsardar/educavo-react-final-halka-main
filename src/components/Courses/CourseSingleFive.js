...
const CourseSingleFive = (props) => {
    const { courseClass, courseImg, courseTitle, coursePrice, categoryClass, courseCategory, author, authorImg, userCount, userRating } = props;
    return (
        <div className={courseClass ? courseClass : 'courses-item'}>
            ...
            <div className="content-part">
                <span><Link className={categoryClass ? categoryClass : 'categories bg3'} to="#">{courseCategory ? courseCategory : 'Web Development'}</Link></span>
